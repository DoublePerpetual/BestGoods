...
// ==========================================
// 全球最佳商品百科全书 · 完全恢复3019 UI + 24.5万数据
// ==========================================
...
<body class="bg-gray-50">
  ...
  pageItems.forEach((item, index) => {
    const hasAnswers = BEST_ANSWERS.some(a => a.level1 === item.l1 && a.level2 === item.l2 && a.item === item.item);
...
app.listen(PORT, () => {
  console.log(`\n🚀 全球最佳商品百科全书 · 完全恢复3019 UI + 24.5万数据 已启动`);
