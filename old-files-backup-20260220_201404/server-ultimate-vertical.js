...
<body class="bg-gray-50 min-h-screen">
  <div class="max-w-4xl mx-auto px-4 py-6">
    ...
    <!-- 价格区间1: 经济型 (垂直排列 - 最上方) -->
    <!-- ========================================== -->
    <div class="price-section bg-white rounded-xl shadow-sm border border-gray-100 p-6 border-l-green-500">
      ...
      <!-- 产品1: 性价比最高 (上) -->
      <div class="product-card border-l-green-500">
      ...
      <!-- 产品2: 最耐用 (中) -->
      <div class="product-card border-l-blue-500">
      ...
      <!-- 产品3: 最舒适 (下) -->
      <div class="product-card border-l-purple-500">
    ...
    <!-- 价格区间2: 标准型 (垂直排列 - 中间) -->
    <!-- ========================================== -->
    <div class="price-section bg-white rounded-xl shadow-sm border border-gray-100 p-6 border-l-blue-500">
      <div class="flex items-center gap-3 mb-6">
      ...
      <div class="product-card border-l-blue-500">
        ...
        <div class="vote-box">
          <div class="text-sm font-medium text-gray-700 mb-3">你认可这个评选结果吗？</div>
          <div class="flex items-center gap-4">
            <button class="flex items-center gap-2 px-4 py-2 rounded-lg border border-green-200 bg-green-50 hover:bg-green