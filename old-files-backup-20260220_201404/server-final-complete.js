...
<body class="bg-gray-50 min-h-screen">
  <div class="container-wide mx-auto px-4 md:px-6 py-5">
    ...
    <div class="mb-7">
      ...
      <div class="text-sm text-gray-500 mt-1">最佳评选结果在最上面 · 重点突出评选理由 · 字体大小优化</div>
    </div>
...
app.listen(PORT, () => {
  ...
  console.log('   2. 其他内容全部保留 - 价格区间、评测维度、评选理由、投票功能');
  console.log('   3. 字体大小调整 - 经济型/标准型/高端型 和 认可/不认可 字体放小');
  console.log('   4. 重点突出评选理由 - "评选逻辑"改为"评选理由"，字体加粗突出');
});
