...
const database = {
  ...
  bestProducts: [
    { priceId: 1, dimensionId: 1, name: '吉列蓝II剃须刀', price: '¥8.5', brand: '吉列 (宝洁公司旗下品牌)', rating: 4, reviews: '1,600+', 
      ...
      likeCount: 42, dislikeCount: 8, userVote: null },
    { priceId: 1, dimensionId: 2, name: '舒适X3经济装', price: '¥12.0', brand: '舒适 (Edgewell Personal Care)', rating: 5, reviews: '1,200+',
      ...
      likeCount: 38, dislikeCount: 5, userVote: null },
    { priceId: 1, dimensionId: 3, name: '飞利浦基础款', price: '¥10.5', brand: '飞利浦 (荷兰皇家飞利浦)', rating: 4, reviews: '760+',
      ...
      likeCount: 35, dislikeCount: 3, userVote: null },
    ...
    { priceId: 2, dimensionId: 1, name: '吉列锋隐5剃须刀', price: '¥25.0', brand: '吉列 (宝洁公司旗下品牌)', rating: 5, reviews: '23,400+',
      ...
      likeCount: 156, dislikeCount: 12, userVote: null },
    { priceId: 2, dimensionId: 2, name: '博朗3系电动剃须刀', price: '¥28.0', brand: '博朗 (德国宝洁旗下)', rating: 5, reviews: '15,600+',
      ...
      likeCount: 128, dislikeCount: 9, userVote: null },
    { priceId: 2, dimensionId: 3, name: '舒适水次元5', price: '¥22.0', brand: '舒适 (Edgewell Personal Care)', rating: 5, reviews: '18,200+',
      ...
      likeCount: 142, dislikeCount: 8, userVote: null },
    ...
    { priceId: 3, dimensionId: 1, name: '吉列锋隐致护', price: '¥45.0', brand: '吉列 (宝洁公司旗下品牌)', rating: 5, reviews: '8,900+',
      ...
      likeCount: 89, dislikeCount: 6, userVote: null },
    { priceId: 3, dimensionId: 2, name: '博朗7系电动剃须刀', price: '¥65.0', brand: '博朗 (德国宝洁旗下)', rating: 5, reviews: '6,500+',
      ...
      likeCount: 76, dislikeCount: 4, userVote: null },
    { priceId: 3, dimensionId: 3, name: '飞利浦高端系列', price: '¥55.0', brand: '飞利浦 (荷兰皇家飞利浦)', rating: 5, reviews: '5,200+',
      ...
      likeCount: 82, dislikeCount: 5, userVote: null }
  ]
};
...
app.get('/category/:level1/:level2/:item', (req, res) => {
  ...
  priceIntervals.forEach(price => {
    ...
    products.forEach(product => {
      ...
      const likeClass = product.userVote === 'like' ? 'bg-green-100 text-green-800 border-green-300' : 'bg-gray-100 text-gray-700 border-gray-200';
      const dislikeClass = product.userVote === 'dislike' ? 'bg-red-100 text-red-800 border-red-300' : 'bg-gray-100 text-gray-700 border-gray-200';
          ...
          <div class="flex justify-between items-start mb-3">
            ...
            <div class="flex gap-2">
              <button onclick="vote('${product.name}', 'like')" 
                      class="px-3 py-1.5 rounded-lg border text-sm font-medium flex items-center gap-1.5 ${likeClass}">
                <i class="fa-solid fa-thumbs-up"></i>
                <span>认可</span>
                <span class="vote-count-like-${product.name.replace(/\s+/g, '-')}">${product.likeCount}</span>
              </button>
              <button onclick="vote('${product.name}', 'dislike')" 
                      class="px-3 py-1.5 rounded-lg border text-sm font-medium flex items-center gap-1.5 ${dislikeClass}">
                <i class="fa-solid fa-thumbs-down"></i>
                <span>不认可</span>
                <span class="vote-count-dislike-${product.name.replace(/\s+/g, '-')}">${product.dislikeCount}</span>
              </button>
            </div>
          </div>
...
<body class="bg-gray-50 min-h-screen">
  <div class="container-narrow mx-auto px-4 md:px-6 py-8">
    <!-- 顶部导航 -->
    <div class="mb-6">
      <div class="flex items-center gap-2 text-sm text-gray-600">
        <a href="http://localhost:3075/" class="nav-link">首页</a>
        <i class="fa-solid fa-chevron-right text-xs"></i>
        <a href="http://localhost:3075/?level1=${encodeURIComponent(level1)}&level2=${encodeURIComponent(level2)}" class="nav-link">${level1}</a>
        <i class="fa-solid fa-chevron-right text-xs"></i>
    ...
    <div class="mb-8">
      ...
      <div class="text-gray-600">
        ...
        <a href="http://localhost:3075/?level1=${encodeURIComponent(level1)}" class="nav-link">${level1}</a>
        <i class="fa-solid fa-chevron-right text-xs mx-1"></i>
        <a href="http://localhost:3075/?level1=${encodeURIComponent(level1)}&level2=${encodeURIComponent(level2)}" class="nav-link">${level2}</a>
        <i class="fa-solid fa-chevron-right text-xs mx-1"></i>
  ...
  <script>
    ...
    function submitComment() {
      ...
      const commentHTML = `
        <div class="p-4 bg-gray-50 rounded-lg">
          <div class="flex items-center gap-2 mb-2">
            ...
            <div>
              <div class="font-medium text-gray-900">匿名用户</div>
      ...
      localStorage.setItem('comments', JSON.stringify(comments.slice(0, 50))); // 只保留最近50条
    }
          ...
          const commentHTML = `
            <div class="p-4 bg-gray-50 rounded-lg">
              <div class="flex items-center gap-2 mb-2">
                ...
                <div>
                  <div class="font-medium text-gray-900">匿名用户</div>
                  <div class="text-xs text-gray-500">${comment.timestamp}</div>
                </div>
              </div>
